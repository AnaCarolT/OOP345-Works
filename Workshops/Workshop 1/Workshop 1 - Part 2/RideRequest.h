...
namespace sdds {
	...
	class RideRequest {
		...
		char* m_rideDescription = nullptr; //It is necessary to use a dynamic char array
	...
	public:
		//Default constructor
		RideRequest();
		//Rule of three is necessary to avoid issues with allocation
		~RideRequest(); //desconstructor
		RideRequest(const RideRequest& riderequest); //copy constructor
		RideRequest& operator=(const RideRequest& riderequest); //copy assignment
